...
struct GPIO_config GUIDED_MODE_INDICATOR_LEDS[]={

		{GPIOC, 11}, //red
		{GPIOC, 10}, //green
		{GPIOC, 12}, //blue
};
struct LED_block GUIDED_MODE_INDICATOR ={
	.leds = GUIDED_MODE_INDICATOR_LEDS , //GPIO information for the LEDs in the block
...
//================================================================================================
// CONFIGURE_STANDARD_LEDS()
// @parm: *GPIOx_LED_config = Pointer to the struct representing the GPIO info needed to configure output
// @return: none
//	 	Conveniently configures a standard (non-RGB) LED
//================================================================================================
...
//================================================================================================
// SETUP_ALTERNATE_FUNCTION_PINS()
// @parm: *RGB_LED = Pointer to the struct representing an RGB LED
// @return: none
//	 	Conveniently configures alternative function mode using GPIO info from RGB LED struct
//================================================================================================
...
// @parm: *RGB_LED = Pointer to the struct representing an RGB LED
// @return: none
//	 	Conveniently configures PWM for RGB LED using timer information from RGB LED struct
//================================================================================================
...
//================================================================================================
// RESET_RGB_CHANNEL()
// @parm: *channels = Pointer to the channels struct (mapped to RGB LED)
// @return: none
//	 	Resets all three channels of an RGB LED
//================================================================================================
...
// @parm: none
// @return: none
//	 	Simultaneously resets both of RGB LEDs used in this program
//================================================================================================
...
//
//================================================================================================
// UPDATE_RGB_CHANNEL_VALUES()
// @parm: *RGB_LED = Pointer to the struct representing an RGB LED
// @parm: r_value = value for the red channel
// @parm: g_value = value for the green channel
// @parm: b_value = value for the blue channel
// @return: none
//	 	Easy way to specifically update values
//================================================================================================
...
// @parm: *RGB_LED = Pointer to the struct representing an RGB LED
// @return: none
// 		Sets the LED color by updating the timer's PWM channels (CCR1, CCR2, CCR3)
//  	with the red, green, and blue values from the struct.
//================================================================================================
...
//================================================================================================
// TURN_OFF_LED_BLOCK()
// @parm: *LED_group = Pointer to the struct representing an LED group
// @return: none
// 		Turns off a LED group/block/cluster
//================================================================================================
